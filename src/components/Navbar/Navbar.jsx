...
const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex-shrink-0">
            <a
              ...
              className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-lg transition-all duration-300"
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden bg-gradient-to-br from-blue-950 via-blue-900 to-purple-950/95 px-6 pb-6 pt-2 shadow-xl animate-fade-in-down">
